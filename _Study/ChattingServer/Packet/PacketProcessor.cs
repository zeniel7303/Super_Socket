...
namespace ChattingServer
{
    class PacketProcessor
    {
        ...
        //receive쪽에서 처리하지 않아도 Post에서 블럭킹 되지 않음
        //BufferBlock<T>(Dataflow.BlockOptions)에서 Dataflow.BlockOptions의
        //BoundedCapacity로 버퍼 가능 수 지정, BoundedCapacity 보다 크게 쌓이면 블럭킹 됨
